...
| **[`archive/`](archive/)** | Decision Log entries older than 90 days, moved here by `automations/scripts/archive_memory.py` so `memory.md` doesn't bloat. Corrected Mistakes and Learned Preferences are never archived. | Auto-generated by the daily sweep. |
